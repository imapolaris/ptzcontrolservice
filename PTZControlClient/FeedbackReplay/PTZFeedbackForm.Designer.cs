namespace PTZControlClient
{
    partial class PTZFeedbackForm
    {
        ...
        {
            this.lineChartControlPan = new PTZControlClient.LineChartControl();
            this.lineChartControlTilt = new PTZControlClient.LineChartControl();
            this.lineChartControlZoom = new PTZControlClient.LineChartControl();
            this.SuspendLayout();
            // 
            // lineChartControlPan
            // 
